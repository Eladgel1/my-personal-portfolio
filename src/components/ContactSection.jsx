                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6 justify-center">
                        <div className="flex items-start spece-x-4">
                            ...
                            <div>
                                <h4 className="font-medium mr-4"> Email</h4>
                                <a href="mailto:eladg3@gmail.com" className="text-muted-foreground hover:text-primary transition-colors ml-2">
                                    eladg3@gmail.com
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start spece-x-4">
                            ...
                            <div>
                                <h4 className="font-medium ml-1"> Phone</h4>
                                <a href="tel:+972525393608" className="text-muted-foreground hover:text-primary transition-colors ml-1">
                                    +972 525393608
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start spece-x-4">
                            ...
                            <div>
                                ...
                                <a className="text-muted-foreground hover:text-primary transition-colors ml-8">
                                    Israel
                                </a>
                            </div>
                        </div>
